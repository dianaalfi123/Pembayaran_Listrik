        ...
        <table id="tabletarif" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-primary" data-toggle="modal" data-target="#edit" href="#" onclick="edit('<?=$data->id_pelanggan?>')">Tambah Penggunaan</a>
                <a class="btn btn-danger" data-toggle="modal" data-target="#hapus" href="#" onclick="edit('<?=$data->id_pelanggan?>')">Detail Penggunaan</a>
                <a class="btn btn-warning" data-toggle="modal" data-target="#nonaktifkan" href="#" onclick="edit('<?=$data->id_pelanggan?>')">Detail Tagihan</a></td>
